...
def make_env(board_size, args, seed=0):
    def _init():
        env = TetrisEnv(board_size=board_size, action_type=args.env_action_type, output_type=args.env_output, simplified=False, score_reward=args.env_score_reward, scale_reward=args.env_reward_scale, max_steps=env_max_step)
        return env
    return _init
